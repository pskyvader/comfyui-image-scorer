...
from external_modules.step02prepare.full_data.config.manager import save_vector_schema
from external_modules.step02prepare.full_data.config.schema import (
    get_vector_order,
    get_total_vector_length,
)
from external_modules.step02prepare.full_data.data.manager import (
    load_index,
...
from external_modules.step02prepare.full_data.features.core import build_feature_vector
from external_modules.step02prepare.full_data.features.embeddings import load_model
